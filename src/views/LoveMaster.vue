...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'AI恋爱大师是ZuoAI超级智能体应用平台的专业情感顾问，帮你解答各种恋爱问题，提供情感建议'
    },
    {
      name: 'keywords',
      content: 'AI恋爱大师,情感顾问,恋爱咨询,AI聊天,情感问题,Zuo,AI智能体'
    }
  ]
})
...
onMounted(() => {
  ...
  // 添加欢迎消息
  addMessage('你好，我是AI恋爱大师，专注于恋爱心理咨询。无论是单身、恋爱还是婚姻中的困惑，都可以向我倾诉，我会为你提供专业的建议和帮助。', false)
})
